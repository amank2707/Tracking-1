...
from BusTrack.helpers.SessionHelper import is_password_correct, get_password_hash
from BusTrack.helpers import utils
from BusTrack.forms.adminforms import UserPasswordForm
from BusTrack.forms.adminforms import AddDriverForm
from BusTrack.forms.adminforms import AddKidForm
...
def login():
    ...
    if form.validate_on_submit() and request.method == 'POST':
        ...
        if app.config['ADMIN_USERNAME'] == form.username.data and \
                is_password_correct(app.config['ADMIN_PASSWORD'], form.password.data):
...
def driver():
    ...
    if form.validate_on_submit() and request.method == 'POST':
        ...
        d = Driver(user_id=form.username.data, bus_id=request.form['bus']
                   ...
                   password=get_password_hash(form.password.data))
        d.add()
        # clear fileds
